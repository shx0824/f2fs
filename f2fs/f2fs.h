...
struct f2fs_inode_info {
	...
	unsigned long i_dyn_flags;	/* use to mark dynamic features added by shixing*/
...
int f2fs_reserve_block(struct inode *, pgoff_t);//added by shixing*/
...
#define MAX_INLINE_DATA		3900 /*(sizeof(__le32) * (ADDRS_PER_INODE + 5))     deleted by shixing*/
